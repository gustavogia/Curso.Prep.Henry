...
//var arreglo =[]
//for(var x in objeto){ arreglo.push([x, objeto[x]])}
//return arreglo
...
for (var i =0 ; i< string.length;i++) {
  if ( !objeto[string [i]]) { objeto[string[i]]=1}
else { objeto[string[i]]=objeto[string[i]]+1}}
return objeto
...
function capicua(numero){
  ...
  if((numero.toString().split('').reverse().join('')) === numero.toString()) { return "Es capicua"}
...
function sortArray(arr) {
 ...
 var nuevoarray = arr.sort(function(a,b){return a.length-b.length})
 return nuevoarray
